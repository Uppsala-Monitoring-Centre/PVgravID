...
The package depends on several R packages. The main dependency is [DiAna](https://github.com/fusarolimichele/DiAna), which is not on CRAN but available on GitHub.
...
Contributors will be acknowledged in the package documentation and/or publications as appropriate.
